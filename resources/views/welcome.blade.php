...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="jumbotron" style="background-image: url('banner/jj.png')">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0">
                                <img src="{{asset('banner/skejul.png') }}" alt="" class="card-img-top">
                                <div class="card-body">
                                    <h3>Manage Event</h3>
                            ...
                            <div class="card border-0">
                                <img src="{{ asset('banner/iya.png') }}" alt="" class="card-img-top">
                                <div class="card-body">
                            ...
                            <div class="card border-0">
                                <img src="{{ asset('banner/oke.png') }}" alt="" class="card-img-top">
                                <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card border-0">
                                <img src="{{ asset('banner/time.png') }}" alt="" class="card-img-top">
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card border-0">
                                <img src="{{ asset('banner/travel.png') }}" alt="" class="card-img-top rounded-circle">
                                <div class="card-body">
